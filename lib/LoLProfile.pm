...
my $summer_info = $ua->get("$euw_endpoint$profile$summer_name$api_key");
my $summer_id   = $summer_info->res->json->{id};
...
my $profile_info = $ua->get("$euw_endpoint$rank_stats$api_key");

print $profile_info->res->body;
